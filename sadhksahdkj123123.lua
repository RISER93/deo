            ...
            if _G.CastleRaid then
                pcall(function()
                    ...
                    if (CFrame.new(-5539.3115234375, 313.800537109375, -2972.372314453125).Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <= 500 then
                        for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                            if _G.CastleRaid and v:FindFirstChild("HumanoidRootPart") and v:FindFirstChild("Humanoid") and v.Humanoid.Health > 0  or _G.CastleRaid and v:FindFirstChild("HumanoidRootPart") and v:FindFirstChild("Humanoid") and v.Humanoid.Health > 0 and _G.AutoLevel then
...
--------------------------------------------------------------------------------------------------------------------------------------------
    ...
    function TPchest(P1)
        ...
        local tween = game:GetService("TweenService"):Create(game.Players.LocalPlayer.Character.HumanoidRootPart,
            TweenInfo.new(Distance / Speed), { CFrame = P1 })
        tween:Play()
    end
    if Third_Sea then
        local ToggleChest = Tabs.Main:AddToggle("ToggleChest", {
            Title = "Auto Chest Stop If Has Items",
...
if Third_Sea then
local ToggleBone = Tabs.Main:AddToggle("TodeggleBone", {
    Title = "Auto Bone",
    Description = "Farm bone legit", 
    Default = false })
...
local boss = Tabs.Main:AddSection("Boss Farm")
    ...
    elseif Third_Sea then
        MaterialList = {
            "Scrap Metal", "Leather", "Demonic Wisp", "Conjured Cocoa", "Dragon Scale", "Gunpowder", "Fish Tail",
            "Mini Tusk"
        }
    end
    ...
    if Third_Sea then
        ...
        local ToggleEspKitsune = Tabs.Main:AddToggle("ToggleEspKitsune",
            { Title = "Esp Kitsune Island", Description = "Định vị Đảo kisune", Default = false })
      ...
      function UpdateIslandKisuneESP() 
        ...
        local ToggleTPKitsune = Tabs.Main:AddToggle("ToggleTPKitsune",
            { Title = "Tween To Kitsune Island", Description = "Di Chuyển Đến Đảo Kisune", Default = false })
                ...
                if _G.CollectAzure then
                    pcall(function()
                        if game:GetService("Workspace"):FindFirstChild("AttachedAzureEmber") then
                            Tween(game:GetService("Workspace"):WaitForChild("EmberTemplate"):FindFirstChild("Part")
                            .CFrame)
                            print("Azure")
                        end
                    end)
...
if Third_Sea then
    ...
    ToggleShip:OnChanged(function(Value)
       ...
       function CheckPirateBoat()
        ...
        local ToggleGhostShip = Tabs.Main:AddToggle("ToggleGhostShip",
            { Title = "Kill Ghost Ship", Description = "Đánh Thuyền Ma", Default = false })
                    ...
                    pcall(function()
                        if CheckPirateBoat() then
                            ...
                            game:GetService("VirtualInputManager"):SendKeyEvent(true, "V", false,
                                game.Players.LocalPlayer.Character.HumanoidRootPart)
                            game:GetService("VirtualInputManager"):SendKeyEvent(false, "V", false,
                                game.Players.LocalPlayer.Character.HumanoidRootPart)
                            wait(0.6)
                            for i, v in pairs(game.Players.LocalPlayer.Backpack:GetChildren()) do
                                if v:IsA("Tool") then
        ...
        local ToggleElite = Tabs.Main:AddToggle("ToggleElite",
            { Title = "Auto Elite Hunter", Description = "Đánh Boss Bí Ẩn", Default = false })
        ...
        spawn(function()
            while task.wait() do
                if _G.AutoElite or _G.AutoElite and _G.AutoLevel then
                    pcall(function()
                            ...
                            if string.find(game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text, "Diablo") or string.find(game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text, "Deandre") or string.find(game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text, "Urban") then
                                if game:GetService("Workspace").Enemies:FindFirstChild("Diablo") or game:GetService("Workspace").Enemies:FindFirstChild("Deandre") or game:GetService("Workspace").Enemies:FindFirstChild("Urban") then
                                    for i, v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                                        if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
                                            if v.Name == "Diablo" or v.Name == "Deandre" or v.Name == "Urban" then
                                                ...
                                                if _G.AutoElite and _G.AutoLevel then
                                                    _G.AutoLevel = true
                                                end
                                            end
                                        end
                                    ...
                                    if game:GetService("ReplicatedStorage"):FindFirstChild("Diablo") then
                                        toTarget(game:GetService("ReplicatedStorage"):FindFirstChild("Diablo")
                                        .HumanoidRootPart.CFrame * CFrame.new(posX, posY, posZ))
                                    elseif game:GetService("ReplicatedStorage"):FindFirstChild("Deandre") then
                                        toTarget(game:GetService("ReplicatedStorage"):FindFirstChild("Deandre")
                                        .HumanoidRootPart.CFrame * CFrame.new(posX, posY, posZ))
                                    elseif game:GetService("ReplicatedStorage"):FindFirstChild("Urban") then
                                        toTarget(game:GetService("ReplicatedStorage"):FindFirstChild("Urban")
                                        .HumanoidRootPart.CFrame * CFrame.new(posX, posY, posZ))
                                    end
                                end
                            end
    ...
    if Third_Sea then
        ...
        local ToggleSeaBeAst = Tabs.Main:AddToggle("ToggleSeaBeAst",
            { Title = "Auto Sea Beast", Description = "Treo + Đánh Thủy Quái", Default = false })
    ...
    if Third_Sea then
                    ...
                    pcall(function()
                        ...
                        elseif game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Hallow Essence") or game:GetService("Players").LocalPlayer.Character:FindFirstChild("Hallow Essence") then
                            ...
                            if game:GetService("ReplicatedStorage"):FindFirstChild("Soul Reaper") then
                                toTarget(game:GetService("ReplicatedStorage"):FindFirstChild("Soul Reaper")
        ...
        local ToggleYama = Tabs.Main:AddToggle("ToggleYama",
            { Title = "Auto Get Yama", Description = "Lấy kiếm Yama", Default = false })
        ...
        local ToggleHoly = Tabs.Main:AddToggle("ToggleHoly",
            { Title = "Auto Holy Torch", Description = "Thắp Duốc lấy Tushita", Default = false })
...
----------------------------------------------------------------------------------------------------------------------------------------------
InterfaceManager:SetFolder("RiserScriptHub")
SaveManager:SetFolder("RiserScriptHub/specific-game")
Window:SelectTab(1)
